...
\item
	...
	\begin{itemize}
		\resitem{Design and implementation of Puppet-based configuration management and provisioning for all new server deployments.}
                \resitem{Administration and support of homogeneous production and development server infrastructure (Solaris, multiple flavors of Linux, some Windows); 200+ machines (physical and virtual), ~30M HTTP requests/day, many web/Java apps on many platforms, lots of outgoing mail.}
                ...
                \resitem{Participation in 24x7 one week on-call rotation for all production services; interface with vendors and Co-Lo providers for troubleshooting and problem resolution.}
                \resitem{Mentoring of junior SAs and technical interviewing of new candidates.}
	\end{itemize}
