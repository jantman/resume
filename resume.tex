...
\item
	...
	\begin{itemize}
                ...
                \resitem{Designed Puppet3 infrastructure using latest best practices; planned and executed migration of ~300 existing nodes to new infrastructure. This included monitoring and deployment/testing (Jenkins) /promotion of code.}
                \resitem{Took lead role in design/planning and build-out of multiple production-like test environments; cut build-out time for environments 2+ by approximately 75\%.}
	\end{itemize}
