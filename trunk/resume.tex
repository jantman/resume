...
\item
	...
	\begin{itemize}
                \resitem{System administration and troubleshooting of service-critical Linux servers, appliances, and network devices.}
                \resitem{Specification, design, implementation and ongoing second-level support of centralized production services including configuration management (Puppet), DHCP, WPA2/RADIUS authentication and accounting, and centralized logging (rsyslog).}
                \resitem{Extensive scripting and custom tool development - Linux services, Puppet, ISC dhcpd, FreeRADIUS, Meru and BlueSocket wireless equipment, etc.}
                ...
                \resitem{Third-level support and troubleshooting of campus-wide wireless network and wired residential network issues.}
                \resitem{Assisted as required with hardware upgrades/installations of wireless equipment and student computer labs.}
		\resitem{Redesign of residential network authentication/registration/DHCP infrastructure.}
		...
		\resitem{Development of server configuration and security policies, and compliance audit tools.}
	\end{itemize}
